/* ! formBuilder - https://formbuilder.online/ Version: 2.9.8 Author: Kevin Chappell <kevin.b.chappell@gmail.com> */
...
!function(A) {
  ...
  112: function(A) {
    ...
    !function() {
      ...
      try {
        c = "function" == typeof clearTimeout
          ? clearTimeout
          : t
      } catch (A) {
        c = t
  ...
  113: function(A, e, t) {
    ...
    function c(A, e) {
      ...
      if (e.singleton) {
        ...
        A.sourceMap && "function" == typeof URL && "function" == typeof URL.createObjectURL && "function" == typeof URL.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa
          ? (t = l(e), r = g.bind(null, t, e), o = function() {
            n(t),
    ...
    function g(A, e, t) {
      ...
      (e.convertToAbsoluteUrls || i) && (r = h(r)),
      ...
      h = function() {
        ...
        A.prototype.setAttrVals = function(A, e) {
          ...
          s.default.forEach(t, function(A) {
            ...
            r = o.attributes.contenteditable
              ? o.innerHTML
              : "checkbox" === o.type
                ? o.checked
                : o.value,
        ...
        A.prototype.updatePreview = function(A) {
          ...
          if (-1 === r.indexOf("input-control")) {
            ...
            var g = b.default.lookup(c.type),
              d = g
                ? g.class
                : w.default.getClass(c.type, c.subtype);
            i = this.layout.build(d, c),
            (0, n.empty)(l[0]),
            l[0].appendChild(i),
            i.dispatchEvent(u.default.fieldRendered)
          }
        },
        ...
        A.prototype.dialog = function(A) {
          ...
          -1 !== t.indexOf("data-dialog") && document.dispatchEvent(u.default.viewData),
          n
        },
        ...
        A.prototype.removeAllFields = function(A) {
          ...
          if (o.prepend && a.push(!0), o.append && a.push(!0), a.some(function(A) {
            ...
            setTimeout(function() {
              (0, n.empty)(A).classList.remove("removing"),
              e.save()
            }, 400)
          } else
            (0, n.empty)(A),
          ...
          A.prototype.orderFields = function(A) {
            ...
            return window.sessionStorage && (
              t.sortableControls
              ? e = window.sessionStorage.getItem("fieldOrder")
              : window.sessionStorage.removeItem("fieldOrder")),
            e
              ? (e = window.JSON.parse(e), e = s.default.unique(e.concat(A)), e = Object.keys(e).map(function(A) {
                return e[A]
              }))
              : e = s.default.unique(r),
          ...
          A.prototype.toggleEdit = function(A) {
            ...
            if (r.length) {
              ...
              r.toggleClass("open"),
              e
                ? ($(".prev-holder", t).slideToggle(250), o.slideToggle(250))
                : ($(".prev-holder", t).toggle(), o.toggle()),
            ...
            $(window).scroll(function(i) {
              ...
              if (n > t.offset().top) {
                var s = Object.assign({
                  ...
                  g = u.top + t.height(),
                  p = f === g && c.top > n;
                f > g && c.top !== u.top && e.css({position: "absolute", top: "auto", bottom: 0, right: 0, left: "auto"}),
                (f < g || p) && e.css(s)
              } else
          ...
          A.prototype.removeField = function(A) {
            ...
            var a = document.getElementById(A),
              l = $(a);
            return a
              ? (l.slideUp(e, function() {
                if (l.removeClass("deleting"), l.remove(), t = !0, r.save(), !o.childNodes.length) {
                  var A = o.parentElement;
                  A.classList.add("empty"),
                  A.dataset.content = g.default.current.getStarted
                }
              }), document.dispatchEvent(u.default.fieldRemoved), t)
              : (console.warn("Field not found"), !1)
          },
          A.prototype.processActionButtons = function(A) {
            var e = A.label,
              ...
              i = this.data;
            e = e
              ? g.default.current[e] || e
              : r.id
                ? g.default.current[r.id] || s.default.capitalize(r.id)
                : "",
            r.id = r.id
              ? i.formID + "-" + r.id + "-action"
              : i.formID + "-action-" + Math.round(1e3 * Math.random());
            var n = B("button", e, r);
            if (t) {
              for (var a in t)
                !function(A) {
          ...
          A.prototype.processSubtypes = function(A) {
            ...
            for (var i in r)
              if (r.hasOwnProperty(i)) {
                for (
                  var n = [], a = r[i], l = Array.isArray(a), s = 0, a = l
                  ? a
                  : a[Symbol.iterator]();;) {
                  var c;
                  if (l) {
          ...
          A.prototype.getFormData = function() {
            ...
            return {
              ...
              json: function(A) {
                return A
                  ? window.JSON.stringify(t.prepData(t.d.stage), null, "\t")
                  : window.JSON.stringify(t.prepData(t.d.stage))
              }
            }[A](e)
          },
          A
      ...
      var E = t(35),
        ...
        Q = function A(e, t) {
          ...
          function o(A, e) {
            ...
            return f.default.inArray(t.type, ["checkbox", "checkbox-group", "radio-group"]) || t.className.push("form-control"),
            t = Object.assign({}, e, t),
            '<div class="form-group ' + A + '-wrap">' + r + '<div class="input-wrap"><input ' + f.default.attrString(t) + "></div></div>"
          }
          function s(A, e) {
            var t = Object.keys(e.options).map(function(A) {
                ...
                return A === e.value && (t.selected = null),
                D("option", e.options[A], t).outerHTML
              }),
              r = {
                id: A + "-" + h.lastID,
                title: e.description || e.label || A.toUpperCase(),
          ...
          var C = new b.default(m, Q),
            D = f.default.markup,
            x = e;
          I.default.loadCustom(e.controls),
          e = C.processOptions(e),
          Object.keys(e.fields).length && M.default.register(e.templates, e.fields);
          var v = B.config.subtypes = C.processSubtypes(e.subtypes);
          C.editorUI(m);
          var N = $(E.stage);
          h.layout = C.editorLayout(e.controlPosition),
          h.formID = m,
          h.lastID = h.formID + "-fld-1";
          var F = I.default.getRegistered(),
            Y = M.default.getRegistered();
          Y && $.merge(F, Y),
          e.sortableControls && E.controls.classList.add("sort-enabled");
          for (var U = $(E.controls), T = [], j = {}, L = 0; L < F.length; L++) {
            ...
            var k = G.icon || S.icon(R),
              ...
              O = k
                ? ""
                : G.iconClassName || "icon-" + R.replace(/-[\d]{4}$/, "");
          ...
          e.inputSets.length && e.inputSets.forEach(function(A, e) {
            var t = A.name,
              r = A.label,
              o = A.icon;
            t = t || f.default.makeClassName(r),
            o && (r = '<span class="control-icon">' + o + "</span>" + r);
            var i = D("li", r, {
          ...
          U.sortable({
            ...
            distance: 3,
            update: function(A, t) {
              return !C.doCancel && void(
                t.item.parent()[0] === E.stage
                ? (C.doCancel = !0, J(t.item))
                : (C.setFieldOrder(U), C.doCancel = !e.sortableControls))
            }
          });
          var J = function(A) {
          ...
          N.on("change blur keyup", X, q),
          $("li", E.controls).click(function(A) {
          ...
          var _ = function() {
              ...
              return e.prepend && !$(".disabled-field.form-prepend", E.stage).length && (A.push(!0), N.prepend(t("prepend"))),
              e.append && !$(".disabled-field.form-.append", E.stage).length && (A.push(!0), N.append(t("append"))),
              C.disabledTT(E.stage),
              A.some(function(A) {
                return !0 === A
              })
            },
            AA = function(A) {
              ...
              if (A instanceof jQuery)
                ...
                t = Object.assign({}, A);
              t.name || (t.name = f.default.nameAttr(t)),
              e && f.default.inArray(t.type, [
                "text",
                "number",
                "file",
                "date",
                ...
                "textarea",
                "autocomplete"
              ]) && (t.className = t.className || "form-control");
            ...
            eA = function(A) {
              if ((A = C.getData(A)) && A.length) {
                for (var t, r = 0; r < A.length; r++)
                  t = f.default.trimObj(A[r]),
                  AA(t);
                Z.classList.remove("empty")
              } else
                e.defaultFields && e.defaultFields.length
                  ? (e.defaultFields.forEach(function(A) {
                    return AA(A)
                  }), Z.classList.remove("empty"))
                  : e.prepend || e.append || (Z.classList.add("empty"), Z.dataset.content = p.getStarted);
              _() && Z.classList.remove("empty"),
              C.save()
            },
            tA = function(A) {
              var e = A.type,
                ...
                a = function(A) {
                  ...
                  return "autocomplete" !== e && (t.selected = !1),
                  t
                };
              if (t && t.length)
                t.forEach(function(A) {
                ...
                var l = [1, 2, 3];
                f.default.inArray(e, ["checkbox-group", "checkbox"]) && (l = [1]),
                t = l.map(function(A) {
                  var e = p.option + " " + A;
                  return a(e)
                });
              ...
              return i.push(g),
              D("div", i, {className: "form-group field-options"}).outerHTML
            },
            rA = function(A) {
              var e = [
                  "required",
              ...
              var i = o[A];
              return "radio-group" === A && f.default.remove("toggle", i),
              f.default.inArray(A, ["header", "paragraph", "button"]) && f.default.remove("description", i),
              r || f.default.remove("value", i),
              i || e
            },
            oA = function(A) {
              var t = A.type,
                  ...
                  access: function() {
                    ...
                    for (a in e.roles)
                      if (e.roles.hasOwnProperty(a)) {
                        ...
                        f.default.inArray(a, l) && (i.checked = "checked"),
                        r.push('<label for="' + o + '">'),
                        r.push(C.input(i).outerHTML),
              ...
              if ("number" === t && ["min", "max", "step"].forEach(function(e) {
                ...
                f.default.inArray(r, e.disabledAttrs) && a.push(!1),
                a.every(function(A) {
                  return !0 === A
                }) && o.push(n[r]())
              }), e.typeUserAttrs[t]) {
            ...
            iA = function(A, e, t) {
              ...
              n = D("div", n, {className: "input-wrap"}).outerHTML,
              D("div", i.concat(n), {
            ...
            nA = function(A) {
              ...
              B.styles.btn.forEach(function(t) {
                var r = [
                  "btn-xs", "btn", "btn-" + t
                ];
                A === t && r.push("selected");
            ...
            aA = function(A, e) {
              ...
              return D("div", [
                '<label for="' + i.id + '">' + r + "</label>",
                '<div class="input-wrap">' + n + "</div>"
              ], {
                className: "form-group " + A + "-wrap"
              }).outerHTML
            },
            lA = function(A, e, t) {
              var r = t.map(function(t, r) {
                  ...
                  return t.value === e[A] && (o.selected = !0),
                  o = f.default.trimObj(o),
                  D("option", o.label, o)
                }),
                o = {
                  id: A + "-" + h.lastID,
                ...
                n = D("label", i, {
                  for: o.id}), a = D("select", r, o), l = D("div", a, {className: "input-wrap"});
              return D("div", [
                n, l
              ], {
          ...
          sA = function(A, e) {
            var t = e[A] || "",
              r = p[A];
            "label" === A && (
              f.default.inArray(e.type, ["paragraph"])
              ? r = p.content
              : t = f.default.parsedHtml(e[A]));
            ...
            if (![].some(function(A) {
              ...
              var n = {
                ...
                "label", r, {
                    for: n.id}).outerHTML;
                "label" === A
                ? (n.contenteditable = !0, i += D("div", t, n).outerHTML)
                : (n.value = t, n.type = "text", i += "<input " + f.default.attrString(n) + ">");
              var l = '<div class="input-wrap">' + i + "</div>", s = "block";
              "value" === A && (s = e.subtype && "quill" === e.subtype && "none"), i = D("div", [
                a, l
              ], {
                className: "form-group " + A + "-wrap",
                style: "display: " + s
          ...
          cA = function(A) {
            var e = A.type,
              t = [],
              r = "";
            return f.default.inArray(e, ["header", "paragraph", "button"]) && t.push(!0),
            t.some(function(A) {
              return !0 === A
            }) || (r = iA("required", A, {first: p.required})),
            r
          },
          uA = function(A) {
            ...
            var a = [
                D("div", n, {className: "field-actions"}),
                D("label", f.default.parsedHtml(o), {className: "field-label"}),
                D("span", " *", {
            ...
            a.push(D("span", "?", l)),
            a.push(D("div", "", {className: "prev-holder"}));
            var s = D("div", [
              oA(A),
              D("a", p.close, {className: "close-field"})
            ...
            var c = D("li", a, {
              ...
              u = $(c);
            u.data("fieldData", {attrs: A}),
            void 0 === C.stopIndex
              ? N.append(u)
              : $("> li", E.stage).eq(C.stopIndex).before(u),
            $(".sortable-options", u).sortable({
              update: function() {
                return C.updatePreview(u)
              }
            }),
            C.updatePreview(u),
            e.typeUserEvents[r] && e.typeUserEvents[r].onadd && e.typeUserEvents[r].onadd(c),
            e.editOnAdd && t && (C.closeAllEdit(), C.toggleEdit(h.lastID, !1)),
            h.lastID = C.incrementId(h.lastID)
          },
          fA = function(A, e, t) {
            var r = {
                selected: t
            ...
            for (var n, a = o.length - 1; 0 <= a; a--)
              if (n = o[a], e.hasOwnProperty(n)) {
                ...
                l.placeholder = p["placeholder." + n] || "",
                "selected" === n && !0 === e.selected && (l.checked = e.selected),
                i.push(D("input", null, l))
              }
            var s = {
              className: "remove btn",
              title: p.removeMessage
            };
            return i.push(f.default.markup("a", p.remove, s)),
            f.default.markup("li", i).outerHTML
          },
          gA = function(A) {
            var t = A.attr("id"),
              r = A.attr("type"),
              ...
              i = r + "-" + o,
              n = A.clone();
            return $(".fld-name", n).val(i),
            n.find("[id]").each(function(A, e) {
            ...
            n.attr("name", i),
            n.addClass("cloned"),
            $(".sortable-options", n).sortable(),
            e.typeUserEvents[r] && e.typeUserEvents[r].onclone && e.typeUserEvents[r].onclone(n[0]),
            h.lastID = C.incrementId(h.lastID),
            n
          };
        if (N.on("click touchstart", ".remove", function(A) {
          ...
          A.preventDefault(),
          2 >= r.querySelector(".sortable-options").childNodes.length && !o.includes("checkbox")
            ? e.notify.error("Error: " + p.minOptionMessage)
          ...
          if ("input" !== A.target.tagName.toLowerCase() && !A.target.contentEditable && (A.stopPropagation(), A.preventDefault(), !0 !== A.handled)) {
            var e = "li" == A.target.tagName
              ? $(A.target).attr("id")
              : $(A.target).closest("li.form-field").attr("id");
            C.toggleEdit(e),
            A.handled = !0
          }
          ...
          "" === r
            ...
            : t.length
              ? t.attr("tooltip", r).css("display", "inline-block")
              : $(".field-label", e).after('<span class="tooltip-element" tooltip="' + r + '">?</span>')
          ...
          A.target.value = f.default.safename(A.target.value),
          "" === A.target.value
            ? $(A.target).addClass("field-error").attr("placeholder", p.cannotBeEmpty)
            : $(A.target).removeClass("field-error")
          ...
          r.val(t),
          e.siblings(".btn").removeClass("selected"),
          e.addClass("selected"),
                ...
                for (;;)
                  switch (e.prev = e.next) {
                    case 0:
                      return e.next = 2,
                      c.
                    default.setCurrent.call(c.default, r);
                    case 2:
                      E.empty(t),
                      o = new A(x, t),
                      $(t).data("formBuilder", o);
                    case 5:
                    case "end":
                      return e.stop()
                  }
  ...
  19 : function(A, e) {
    ...
    o.trimObj = function(A) {
      ...
      for (var t in A)
        o.inArray(A[t], e)
          ? delete A[t]
          : Array.isArray(A[t]) && (A[t].length || delete A[t]);
      return A
    },
    ...
    o.safeAttr = function(A, e) {
      ...
      return e && (
        Array.isArray(e)
        ? t = o.escapeAttr(e.join(" "))
        : ("boolean" == typeof e && (e = e.toString()), t = o.escapeAttr(e.replace(",", " ").trim()))),
      e = e
        ? '="' + t + '"'
        : "", {
        name: A,
    ...
    o.contentType = function(A) {
      var e = void 0 === A
        ? "undefined"
        : r(A);
      return A instanceof Node || A instanceof HTMLElement
        ? e = "node"
        : Array.isArray(A) && (e = "array"),
      e
    },
    ...
    o.parseXML = function(A) {
      ...
      if (t)
        for (var i = t.getElementsByTagName("field"), n = 0; n < i.length; n++) {
          ...
          l && l.length && (a.values = o.parseOptions(l)),
          r.push(a)
        }
      return r
    },
    ...
    o.getScripts = function(A, e) {
      ...
      o.isCached(A) || (r = t.map(A, function(A) {
        return t.ajax({
          dataType: "script",
          cache: !0,
          url: (e || "") + A
      ...
      A.forEach(function(A) {
        ...
        if ("object" == (
          ...
          t = A.type || (
            A.style
            ? "inline"
            : "href"), n = A.id, A = "inline" == t
          ? A.style
          : A.href,
        i = n || A.href || A.style), !o.isCached(i, "css")) {
          if ("href" == t) {
    ...
    o.merge = function(A, e) {
      ...
      for (var i in e)
        t.hasOwnProperty(i) && (
          t[i] = Array.isArray(e[i])
          ? Array.isArray(A[i])
            ? o.unique(A[i].concat(e[i]))
            : e[i]
          : "object" === r(e[i])
            ? o.merge(A[i], e[i])
            : e[i]);
          ...
          n = function() {
            function A() {
              ...
              this.init = function(A) {
                return e.config = Object.assign({}, t, A),
              ...
              if (e && n)
                if ("object" === (
                  ...
                  for (var a = 0; a < n.length; a++)
                    t = n[a].substring(1, n[a].length - 1),
                    i = i.replace(r.makeSafe(n[a]), e[t] || "");
            else
                i = i.replace(/\{[^\}]+?\}/g, e);
              return i
            },
    ...
    var a = function() {
      ...
      f = function(A) {
        ...
        e.register = function() {
          ...
          s.default.register(Object.keys(A), e);
          for (
            var o = t, i = Array.isArray(o), n = 0, o = i
            ? o
            : o[Symbol.iterator]();;) {
            var a;
            if (i) {
            ...
            if (!A[c]) {
              ...
              if (!g) {
                this.error("Error while registering custom field: " + c + (
                  l.subtype
                  ? ":" + l.subtype
                  : "") + ". Unable to find any existing defined control or template for rendering.");
                continue
              }
              f = c + "-" + _Mathfloor(9e3 * Math.random() + 1e3),
              e.customRegister[f] = $.extend(l, {
                type: c,
                class: g
              })
            }
            e.def.i18n[r][f] = l.label,
            e.def.icon[f] = l.icon
          }
        },
        e.getRegistered = function() {
          ...
          return A
            ? s.default.getRegistered(A)
            : Object.keys(e.customRegister)
        },
        e.lookup = function(A) {
        ...
        e.prototype.build = function() {
          ...
          for (
            var t = Object.assign(this.config), r = [
            "label",
            "description",
            "subtype",
            "id",
  ...
  36 : function(A, e, t) {
        ...
        e.prototype.build = function() {
          var A = this.config,
            ...
            t = void 0 === e
              ...
              : e,
            o = r(A, ["value"]);
          return this.field = this.markup("textarea", this.parsedHtml(t), o),
          this.field
        },
    ...
    e.default = c,
    s.default.register("textarea", c),
    s.default.register("textarea", c, "textarea")
  },
  51 : function(A, e) {
    "use strict";
    function t(A, e) {
    ...
    var r = e.instanceDom = {},
      ...
      n = e.filter = function(A, e) {
        ...
        for (var i, n = A.length - 1; 0 <= n; n--)
          i = A[n].textContent.toLowerCase(),
          -1 === i.indexOf(e.toLowerCase())
            ? A[n].style.display = o[1]
            : (A[n].style.display = o[0], r.push(A[n]));
        return r
      },
      a = e.optionFields = [
        "select", "checkbox-group", "checkbox", "radio-group", "autocomplete"
      ],
    ...
    e.defaultI18n = {
      ...
      preloaded: {
        "en-US": {
          ...
          editXML: "Edit XML",
          enableOther: "Custom",
          enableOtherMsg: "Let me enter a custom option",
          fieldNonEditable: "This field cannot be edited.",
          fieldRemoveWarning: "Are you sure you want to remove this field?",
          fileUpload: "File Upload",
          formUpdated: "Form Updated",
          getStarted: "Build your feedback structure by dragging a field to this area.",
          header: "Header",
          hide: "Edit",
          hidden: "Hidden Input",
          inline: "Inline",
  ...
  53 : function(A, e) {
    ...
    function t(A) {
      ...
      return "function" == typeof Event
        ? e = new Event(A)
        : (e = document.createEvent("Event"), e.initEvent(A, !0, !0)),
      e
    }
    Object.defineProperty(e, "__esModule", {
      value: !0
    ...
    var n = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator
      ...
      f = function() {
        function A(e, t) {
          ...
          for (
            var r = [
            "label", "description", "subtype", "required"
          ], o = r, n = Array.isArray(o), a = 0, o = n
            ? o
            : o[Symbol.iterator]();;) {
            var l;
            if (n) {
          ...
          e.id || (
            e.name
            ? e.id = e.name
            : e.id = "control-" + _Mathfloor(1e7 * Math.random() + 1)),
          this.id = e.id,
          this.type = e.type,
          ...
          var c = this.subtype
            ...
            : this.type;
          this.classConfig = $.extend({}, A.controlConfig[c] || {}),
        ...
        return A.register = function(e, t, r) {
          ...
          Array.isArray(e) || (e = [e]);
          for (
            var i = e, n = Array.isArray(i), a = 0, i = n
            ? i
            : i[Symbol.iterator]();;) {
            var l;
            if (n) {
            ...
            var s = l;
            -1 < s.indexOf(".")
              ? A.error("Ignoring type " + s + ". Cannot use the character '.' in a type name.")
              : A.classRegister[o + s] = t
          }
        },
        ...
        A.loadCustom = function(e) {
          ...
          if (e && (t = t.concat(e)), window.fbControls && (t = t.concat(window.fbControls)), !window.fbControlsLoaded) {
            for (
              var r = t, o = Array.isArray(r), i = 0, r = o
              ? r
              : r[Symbol.iterator]();;) {
              var n;
              if (o) {
          ...
          var e = this,
            t = {
              ...
              render: function() {
                ...
                e.js && !s.default.isCached(e.js)
                  ? s.default.getScripts(e.js).done(A)
                  : A()
              }
            };
          return A
        ...
        A.prototype.markup = function(A) {
          var e = 1 < arguments.length && void 0 !== arguments[1]
            ...
            t = 2 < arguments.length && void 0 !== arguments[2]
              ? arguments[2]
              : {};
          return this.element = s.default.markup(A, e, t),
          this.element
        },
      ...
      a = function() {
        function A(e, t) {
          ...
          this.templates = {
            ...
            default: function(A, e, t, r) {
              t && e.appendChild(t);
              var i = r.id
                ? "fb-" + r.type + " form-group field-" + r.id
                : "";
              return o.markup("div", [
                e, A
              ], {className: i})
        ...
        A.prototype.build = function(A, e, t) {
          this.preview && (
            e.name
            ? e.name += "-preview"
            : e.name = n.default.nameAttr(e) + "-preview"),
          e.id = e.name,
          this.data = $.extend({}, e);
        ...
        A.prototype.label = function() {
          var A = this.data.label || "",
            ...
            t = [e];
          return this.data.required && t.push(this.markup("span", "*", {className: "fb-required"})),
          this.isTemplate("label")
            ? this.processTemplate("label", t)
            : this.markup("label", t, {
              for: this.data.id, className : "fb-" + this.data.type + "-label"})},
        ...
        A.prototype.processTemplate = function(A) {
          for (var e, t = arguments.length, r = Array(
            1 < t
            ? t - 1
            : 0), o = 1; o < t; o++)
            r[o - 1] = arguments[o];
        ...
        function c(A) {
          function e(e, t) {
            ...
            return n instanceof s
              ? Promise.resolve(n.arg).then(o, i)
  ...
  77 : function(A, e, t) {
    ...
    var a = t(6),
      ...
      c = function(A) {
          ...
          var A = this,
              ...
              var t = e.target.nextSibling.nextSibling,
                ...
                i = new Map([
                  ...
                  [
                    ...
                    function() {
                      o && (
                        e.target.value = o.innerHTML, r.value = o.getAttribute("value"), "none" === t.style.display
                        ? A.showList(t, o)
                        : A.hideList(t)),
                      e.preventDefault()
                    }
            ...
            a = Object.assign({}, i, {
              ...
              events: {
                ...
                blur: function(A) {
                  A.target.removeEventListener("keydown", n),
                  setTimeout(function() {
        ...
        e.prototype.hideList = function(A) {
          this.selectOption(A, null),
          A.style.display = "none"
        },
        e.prototype.showList = function(A, e) {
          this.selectOption(A, e),
          A.style.display = "block",
          A.style.width = A.parentElement.offsetWidth + "px"
        },
    ...
    e.default = c,
    l.default.register("autocomplete", c)
  },
  78 : function(A, e, t) {
    "use strict";
    function r(A, e) {
  ...
  79 : function(A, e, t) {
            ...
            t = $.extend(!0, {
              ...
              callbacks: {
                ...
                onStatusChange: function() {
                  for (
                    var t = A.fineUploader("getUploads"), r = [], o = t, i = Array.isArray(o), n = 0, o = i
                    ? o
                    : o[Symbol.iterator]();;) {
                    var a;
                    if (i) {
    ...
    e.default = s,
    l.default.register("file", l.default, "file"),
    l.default.register("fineuploader", s, "file")
  },
  80 : function(A, e, t) {
    "use strict";
    function r(A, e) {
    ...
    var a = function() {
      ...
      c = function(A) {
          ...
          if ((u.multiple || "checkbox-group" === a) && (u.name += "[]"), "checkbox-group" === a && u.required && (this.onRender = this.groupRequired), delete u.title, o) {
            ...
            for (var d, p = 0; p < o.length; p++) {
              ...
              if (B.id = u.id + "-" + p, (!B.selected || n) && delete B.selected, void 0 !== i && B.value === i && (B.selected = !0), g) {
                ...
                l && (I += "-inline"),
                B.type = f,
                B.selected && (B.checked = "checked", delete B.selected);
        ...
        e.prototype.otherOptionCB = function(A) {
          ...
          document.getElementById(A + "-value").style.display = e.checked
            ? "inline-block"
            : "none"
        },
        a(e, null, [
  ...
  83 : function(A, e, t) {
    ...
    var a = t(36),
      ...
      s = function(A) {
        ...
        e.prototype.build = function() {
          var A = this.config,
            e = (A.value, r(A, ["value"]));
          return this.field = this.markup("div", null, e),
          this.field
        },
        e.prototype.onRender = function() {
          ...
          t.data = new e,
          A && t.instance.setContents(window.JSON.parse(this.parsedHtml(A))),
          t.instance.on("text-change", function(A) {
    ...
    e.default = s,
    l.default.register("quill", s, "textarea")
  },
  84 : function(A, e, t) {
    "use strict";
    function r(A, e) {
    ...
    e.default = s,
    l.default.register("tinymce", s, "textarea")
  }
});
